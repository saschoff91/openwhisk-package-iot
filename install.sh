...
$WSK_CLI -v --apihost "$APIHOST" package update --auth "$AUTH" --shared yes /whisk.system/iot \
...
$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes /whisk.system/iot/create_device_type "$PACKAGE_HOME/actions/create_device_type.js" \
...
$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes /whisk.system/iot/delete_device_type "$PACKAGE_HOME/actions/delete_device_type.js" \
    -a description 'Create new device Type in Watson IoT platform' \
    -a parameters '[{"name":"apiKey","required":true,"bindTime":true,"description":"Watson IoT platform API Key"},{"name":"apiToken","required":true,"bindTime":true,"description":"Authentication token of an Watson IoT platform","type":"password"},{"name":"orgId","required":true,"bindTime":true,"description":"IoT platform Organization Id"},{"name":"typeId","required":true,"bindTime":true,"description":"Device Type ID"}]' \
    -a sampleInput '{ "apiKey": "XXXXXX", "apiToken": "YYYYYY", "orgId": "ZZZZ", "typeId": "Raspberry_Pi" }' \
    -a sampleOutput '{"successc":"device type deleted"}'

$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes /whisk.system/iot/register_device "$PACKAGE_HOME/actions/register_device.js" \
...
$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes /whisk.system/iot/delete_device "$PACKAGE_HOME/actions/delete_device.js" \
...
$WSK_CLI -v  --apihost "$APIHOST" action update --auth "$AUTH" --shared yes /whisk.system/iot/send_event "$PACKAGE_HOME/actions/send_event.js" \
